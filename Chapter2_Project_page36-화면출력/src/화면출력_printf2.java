...
public class 화면출력_printf2 {
	...
	public static void main(String[] args) {
		...
		// new -> 메모리에 저장(객체 생성), System.in:키보드 입력값
		// 키보드 입력값을 받아서 --> 해당 변수에 값을 대입
		System.out.print("국어 점수 입력:");
		kor = sc.nextInt(); // 정수값 저장, next():문자열, nextDouble():실수형 -->40page
		...
		System.out.printf("%-5d%-5d%-5d%-5d%-5.2f", kor,eng,math,total,avg); //다음줄에 출력이 없다
		//3.연산
		//4.화면 출력
