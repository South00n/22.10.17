...
/*
 * 	   java.lang -> 프로그램에서 가장 많이 사용되고 기본이 되는 클래스의 집합
 * 	   ---------	---------------------- import를 생략할 수 있다
 ...
 *     	
 *     	  **3. 소멸자 : 객체 메모리 제거
 *     		 protected void finalize(); ==> 메소드 소멸자
 *     		
...
class Main {
	 ...
	 * 	  class A {
	 * 		public A() {new}
	 * 	    public ~A() {delete} -> 자동 처리로 바뀜 (GC) -> 해제되는 시간 (메모리 누수) -> gc() 호출
	 * 		// 객체는 null을 설정
	 * 		// 사용하지 않는 경우 
	 * 	  }
	 */
	...
	protected void finalize() throws Throwable {
		System.out.println("객체 소멸(메모리에서 해제)..");
	}
	// Object가 가지고있는 메소드
}
