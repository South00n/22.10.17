...
public class 라이브러리_4 {
	...
	public static void main(String[] args) {
		...
		// 한글을 빼고 나머지는 공백 ^ => 제외하고
		System.out.println("영문만 출력 : " + s.replaceAll("[^A-Za-z]", ""));
		...
		// 원형 public String substring(int s) : s부터 끝까지
		// 	   public String substring(int s, int e) : s부터 e-1번까지
		...
		System.out.println(index);
		String temp2 = "adsadfaks.asdasd.png";
