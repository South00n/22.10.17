...
public class MainClass_ArrayList_3 {
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < list.size(); i++) {
			...
			/*
			 * System.out.println("사번 : " + sa.getSabun()); System.out.println("이름 : " +
			 * sa.getName()); System.out.println("부서 : " + sa.getDept());
			 * System.out.println("근무지 : " + sa.getLoc()); System.out.println("연봉 : " +
			 * sa.getPay()); System.out.println("---------------------");
			 */
		...
		temp.addAll(list); // 전체 데이터 저장 => 중복 데이터 제거 => 제거된 데이트를 받는 경우
		...
		Sawon sa = new Sawon();
		System.out.print("이름 입력 : ");
		sa.setName(sc.next()); // String name = sc.next()
