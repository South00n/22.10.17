 ...
 *    1. Random (500page) => java.util (import 사용 필수) : 임의의 수 추출
 *    	 = nextInt() => 정수형 난수를 발생 (범위 => int)
 *    	 = nextInt(int i) => 지정
 *     	   nextInt(100) => 0 ~ 99
 *     	   nextInt(1000) => 0 ~ 999
 *     
 ...
 *    			   nextInt(), next()
 *    	
 *    3. StringTokenizer : 문자열을 자른다 (웹, 서버에서 많이 사용) + 빅데이터 // 문자 구분이 필요할떄
 *    ------------------------- 9장
 *    4. Date
 *    5. Calendar
 *    -------------------- 10장
 ...
 *    						------- 11장
 *    
 *    15장 java.io / 16장 java.net / java.sql / java.text (SimpleDataFormat, MessageFormat, ChoiceFormat)
 *    -----------------------------------------
