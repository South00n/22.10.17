...
/*
 *    C/S => 네트워크
 *    		 흐름 (서버의 기능, 클라이언트 기능) ==> 웹 프로그램, 오라클 프로그램
 *    										-------------------- 이미 서버가 만들어져 있다
 *    			  요청
...
public class Function {
	public static final int LOGIN = 100; // 로그인 기능 ==> 내부 프로토콜 (프로그램에서의 약속)
	// LOGIN => 이미 로그인된 사람 처리 
	public static final int MYLOG = 110; // 로그인 하는 사람 처리
	public static final int MAKEROOM = 200; // 방 만들기 기능
	public static final int ROOMIN = 210; // 이미 방에 들어가있는 상태
	...
	public static final int CHATEND = 900; // 종료하기 (남아있는사람)
