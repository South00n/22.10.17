 ...
 *    		------------------------- 다른 주소에 저장
 *    5) 주요메소드 (자바스크립트와 동일)
 *    	 **1. public char charAt(int index) : 문자열에서 원하는 위치의 문자 한개 추출
 *    			   ----  	   ---------
 *    			  리턴형			매개변수 중요
 ...
 *       	String s = "안녕하세요"; ==> s.length() => 5 - 한글도 동일하다
 *       	==> 사용처 : 화면 UI (글자수를 동일하게 만드는 경우에 주로 사용) => HTML(유연성)
 *       3. toUpperCase() : 대문자 변환
 *       	public String toUpperCase() : 대문자로 변환 => 컬럼명 / 테이블명 (배열)
 *       											   ---- 멤버변수
 *       											   ---- 클래스 (ROW)
 ...
 *       **5) equalsIgnoreCase : 문자열이 같은 경우 (대소문자 상관x)
 *       	public boolean equalsIgnoreCase(String s)
 *       ===> 웹 : 회원가입, 로그인, 게시판, 검색기 ...
 *       *** 사이트 : 회원가입, 게시판, 공지사항, 로그인, 검색기 (필수)
 *       변경 (문자열 변경, 추가, 제거)
 *        1) concat ==> 문자열 결합 (MySQL에서는 concat사용)
 ...
 *             public String valueOf(int a)             
 *             public String valueOf(double a)             
 *             public String valueOf(char[] a)             
 *             ..
 *             ..
 *             ..
 */
public class 라이브러리_1 {
	...
	public static void main(String[] args) {
		//charAt : public char charAt(int index) : 지정된 위치의 문자를 읽어 올때 사용 (웹에서는 사용 빈도 거의 없다)
		/*String s = "Hello Java";
		// 			0123456789
		char c = s.charAt(4);
