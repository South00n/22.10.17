 ...
 *    	   검색하기 => 메소드
 *    	  -------------------- 게시판 기능
 *    	  메소드 => 리턴형 / 매개변수 (여러개 설정 가능) => Call By Value (메소드에서만 변경)
 ...
 *    		println(boolean b) --> printBoolean() .. (오버로딩이 없었다면)
 *    		println(char[] c)
 *    		println(double d)
 *    		println(String s)
 *    		..
 ...
 *     				void display(double a, int c, int d)
 *     
 *     				display(10.0, 'A', 10.5F)
 *     					double char float // 형식이 가장 비슷한 메소드를 호출한다
 *     										1. 같은 매개변수
 *     										2. 큰 데이터형 변수
 */
public class 오버로딩_1 {
