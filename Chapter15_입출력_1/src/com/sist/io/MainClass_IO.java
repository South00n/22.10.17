 ...
 * 					   => 스트림의 단점 : 단방향 (양방향 => 쓰레드를 이용해서 프로그램을 두개돌린다)
 * 					   => 빨대 
 * 					   => FIFO (Queue)
 * 				 라이브러리
 * 				 -------
...
public class MainClass_IO {
	...
	public static void main(String[] args) {
		...
		try {
			...
			SimpleDateFormat sdf = new SimpleDateFormat("yyyy 년도 MM월 dd일 hh시 mm분 ss초");
			System.out.println("파일수정일 : " + sdf.format(new Date(file.lastModified())));
			System.out.println("숨길파일 : " + file.isHidden());
