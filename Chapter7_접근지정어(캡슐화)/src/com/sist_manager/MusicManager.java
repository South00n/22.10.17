package com.sist_manager;
// 사용자정의 타입(MusicVO => 활용) => 메소드
 ...
 *    => 명시적인 초기화가 불가능 할 때는 반드시 초기화 블록이나 생성자를 이용한다
 *    => 접근 범위
...
public class MusicManager {
	...
	// 초기화 블록 / 생성자 ==> 파일읽기(구현) => 클래스영역에서 불가능
	/*
	 *   변수의 초기화
	 *   인스턴스
	 *   정적변수(static)
	 *   ---------------
	 *   	명시적인 초기화		int a = 10;
	 *   	초기화 블록	, 생성자 => 파일을 읽어서 초기화, 외부에서 크롤링 ...
	 *   	--------
	 *   	인스턴스 블록 : 인스턴스변수 초기화
	 *   	{
	 ...
	 *   	static블록 : static 초기화
	 *   	static {
	 *   		static변수만 초기화 가능 (인스턴스 변수는 사용이 안됨)
	 *   	}
	 *   
