 ...
 * 				2) throws : 선언만 처리
 * 
 * 				public void display() throws Exception { => display를 호출시에는 Exception처리한 후 사용한다
 * 			
 * 				}
 * 			
 * 				public void aaa() {
...
public class MainClass_예외처리_1 {
	// CheckException => 컴파일러가 예외처리가 됐는지 확인 => 반드시 예외처리해서 사용한다
