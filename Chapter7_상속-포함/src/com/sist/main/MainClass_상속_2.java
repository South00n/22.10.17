...
class Super2 {
	...
	// 생성자, 초기화블록은 상속이 안된다, static은 상속이 아니라 공유
...
class Sub2 extends Super2 {
	 ...
	 *  							 --------- 상위클래스로 메모리 할당시에는 상위클래스가 가지고 있는 변수만 접근이 가능
	 *  		=> 인터페이스나 추상 클래스에서 등장
	 *  		   ---------------- 미완성된 클래스 => 완성해서 사용
	 *  	*** B d = (B)new A(); ==> 형변환의 오류발생 ==> 하위 클래스가 가지고 있는 변수에 접근이 가능
	 *  		=> 라이브러리 클래스에서 주로 사용된다
	 *  	
...
public class MainClass_상속_2 {
	...
	public static void main(String[] args) {
		...
		//System.out.println("sup.c = " + sup.c); 오류
		
		//Sub2 sub2 = (Sub2)new Super2(); // a, b, c ==> ClassCastException
