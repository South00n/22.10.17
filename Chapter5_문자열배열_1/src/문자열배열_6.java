...
public class 문자열배열_6 {
	...
	public static void main(String[] args) {
		...
		int curpage = 1;
		int rowSize = 10;
		int totalPage = (int)(Math.ceil((guest.length) / (double)rowSize));
		
		System.out.print("페이지를 입력해주세요 (1 ~ " + totalPage + "):");
		curpage = sc.nextInt();
        System.out.println(curpage + "페이지 / " + totalPage + "페이지");
		System.out.println("=======" + curpage + "페이지 내용 =======");
		...
		System.out.println();
		System.out.println("=======게스트하우스 검색========");
		System.out.print("게스트하우스 이름을 입력해주세요:");
		String fd = sc.next();
